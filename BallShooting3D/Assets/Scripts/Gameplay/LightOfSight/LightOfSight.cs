...
public class LightOfSight : MonoBehaviour
{
    ...
    public float lightDistance = 15.5f;
    public float lightOfSightHeight = 1f;
    void Start()
    {
        mesh = new Mesh();
    ...
    void Update()
    {
        if (_isShow)
        {
            ...
            vertices[0] = RotatePoint(new Vector3(-0.1f, lightOfSightHeight, 0), new Vector3(), angle);
            vertices[1] = RotatePoint(new Vector3(-0.05f, lightOfSightHeight, lightDistance), new Vector3(), angle);
            vertices[2] = RotatePoint(new Vector3(0.1f, lightOfSightHeight, 0), new Vector3(), angle);
            vertices[3] = RotatePoint(new Vector3(0.05f, lightOfSightHeight, lightDistance), new Vector3(), angle);
